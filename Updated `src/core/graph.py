...
from src.core.qa_agent import QAgerAgent  # Updated to use QAgerAgent instead of QAGerAgent
...
class DevBandOrchestrator:
    def __init__(self):
        ...
        self.qa_agent = QAgerAgent(self.state_manager, self.llm_client)  # Updated to use QAgerAgent instead of QAGerAgent
